...
public class UserServiceImplementer implements UserService {
	...
	@Override
	public UserResponse addNewUser(UserModel user, HttpServletRequest req) throws UnknownHostException,
	...
	@Override
	public UserResponse userLoginCheck(UserModel user, HttpServletRequest req) throws UnknownHostException,
