    ...
    enable: function() {
      ...
      if (this.settings.allowMoving && (('draggable' in div) || ('ondragstart' in div && 'ondrop' in div))) {
        ...
        draggableHandles.attr('draggable', true)
          .on('dragstart.powertable', function(e) {
            currDrag = this;
          });
        draggables
          .on('dragenter.powertable', function(e) {
            $(this).addClass('ptdragover');
          })
          .on('dragleave.powertable', function(e) {
            $(this).removeClass('ptdragover');
          })
          .on('dragover.powertable', function(e) {
            if (e.preventDefault) {
              e.preventDefault();
            }
          })
      ...
      this.scrollingParent.on('powertable:scrollstart', function(e) {
        inst._scrollStart();
      });
      this.scrollingParent.on('powertable:scrollend', function(e) {
        inst._scrollEnd();
      });
